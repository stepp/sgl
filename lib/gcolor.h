...
private:
     ...
     */
    static const std::map<std::string, int>& colorTable();

    /**
     * Returns a reference to the table of common colors,
     * mapping from names to color strings.
     */
    static const std::map<std::string, std::string>& colorNameTable();

    // internal color tables
    static std::map<std::string, int> _colorTable;
    static std::map<std::string, std::string> _colorNameTable;
};
